/*
 * Menu: MillerMedeiros > Editors > To Proper Case
...
function main() {
	...
	if(editors.activeEditor !== undefined){
			...
			output = selected.toLowerCase().replace(/^[a-z\xE0-\xFF]|\s[a-z\xE0-\xFF]/g, capsFn); //replace first char of each word to UPPERCASE
